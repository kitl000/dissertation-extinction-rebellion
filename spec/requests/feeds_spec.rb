  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Feed" do
        expect {
          post feeds_url, params: { feed: valid_attributes }
    ...
    context "with invalid parameters" do
      it "does not create a new Feed" do
        expect {
          post feeds_url, params: { feed: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested feed" do
        feed = Feed.create! valid_attributes
        patch feed_url(feed), params: { feed: new_attributes }
        feed.reload
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        feed = Feed.create! valid_attributes
        patch feed_url(feed), params: { feed: invalid_attributes }
        expect(response).to be_successful
      end
    end
  end
